...
public class SqliteTransactionDAO implements TransactionDAO {
    ...
    public Integer create(Transaction transaction) {
        ...
        try(PreparedStatement stmt = ConnectionFactory.createPreparedStatement(sql)) {
            stmt.setString(1, transaction.getUser().getInstitutionallId());
            stmt.setInt(2, transaction.getBook().getId());
            stmt.setString(3, transaction.getIssueDate().toString());
    ...
    @Override
    public Optional<Transaction> findByDataRange(LocalDate initialDate, LocalDate finalDate, String institutionallId, Integer id) {
    ...
    public boolean update(Transaction transaction) {
        ...
        try(PreparedStatement stmt = ConnectionFactory.createPreparedStatement(sql)) {
            ...
            stmt.setInt(2, transaction.getBook().getId());
            stmt.setString(3, transaction.getIssueDate().toString());
            stmt.setString(1, transaction.getDueDate().toString());
