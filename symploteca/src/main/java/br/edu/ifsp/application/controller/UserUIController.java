...
public class UserUIController {
    ...
    public void saveOrUpdate(ActionEvent actionEvent) throws IOException {
        getEntityFromView();
        boolean newUser = findUserUseCase.findOne(user.getInstitutionallId()).isEmpty();
    ...
    private void createUserProperKind() {
        ...
        user.setInstitutionallId(txtInstitutionId.getText().trim().toUpperCase());
    }
    ...
    private void setEntityIntoView() {
        ...
        txtInstitutionId.setText(user.getInstitutionallId());

        boolean faculty = user instanceof Faculty;
        ckFaculty.setDisable(faculty);
